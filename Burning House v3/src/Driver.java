...
public class Driver extends Game{
	...
	public static void kill(Person p) {
		...
		if(player.followTrain.contains(p))
			player.followTrain.subList(player.followTrain.indexOf(p), player.followTrain.size()).clear();;
	}
