...
public class EightPuzzleTest {
	...
	public void testSwap() {
		List<Integer> swapped = ((EightPuzzle) oneStepPuzzle).swap(oneStep, 5, 8);
		assertTrue(swapped.equals(
				Arrays.asList(new Integer[] { 1, 2, 3,
											  4, 5, 6, 
											  7, 8, 0 })));
		assertEquals(swapped, solved);
		assertTrue(oneStepPuzzle.isGoal(swapped));
